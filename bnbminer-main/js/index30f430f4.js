...
const contractAddress = '0xf969D20c84c7f9e2f3896B3e13B82A07EAffe9cC'
// prettier-ignore
...
var app = new Vue({
  ...
  async mounted() {
    var countDownDate = new Date('October 9, 2023 17:00:00').getTime()
  ...
  methods: {
    ...
    // const web3 = new Web3('https://data-seed-prebsc-2-s1.bnbchain.org:8545')
	  ...
	  bakePizza() {
			...
			let wallet_referrarAddr = '0x0fb95726229F574657efC4898402C0C699329B0C';
    ...
    rebakePizza() {
      console.log(this.referrarAddr)
      if (Number(this.hatcheryMiners) < 0.005) {
        this.notify('Minimum rebake limit is 0.005 BNB')
        return
      }
      this.contractInstance.methods
